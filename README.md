...
> ⚠️ **開発・監修に関するご注意**
> * 本システムはAIによってコードの大部分が生成されていますが、AI特有の実装不可能な機能の提案やAIでは作れないシステム（どうしてもアメリカ仕様になるなど）が含まれていたため、人の手による修正・調整が少なからず加えられています。原形をとどめていないところもあるので、「AIでこんなツールが生成できる！」という紹介などに使うのはやめたほうが良いかもしれません。
